...
class DeficitComponent extends Component {
    ...
    fat(){
        this.setState({fat: parseInt(this.state.weight) * .430})
    ...
    render() {
        return (
            <form> 
                ...
                <div class="card">
                    <img src="images/loseweight.jpg" class="thumbsup"></img>
                <h3>Lose</h3>
                <div class="container">
                Total Cal:<input type="text" id="totalCal1" placeholder="Total" Value={this.state.total}   />  <br></br>
                 Protein:<input type="text" id="protein1" placeholder="Grams" Value={this.state.protein}   /><br></br>
                 Carbs:<input type="text" id="carb1" placeholder="Grams" Value={this.state.carb}   /> <br></br>
                 Fats:<input type="text" id="fat1" placeholder="Grams" Value={this.state.fat}   />
                </div>
                </div>
                </div>
...
export default DeficitComponent;